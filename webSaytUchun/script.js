...
const testimonials = [
    {
        text: "Dostonbek Academy'da 6 oylik Frontend kursini tamomladim. Hozirda ish topdim va yuqori maosh olmoqdaman. O'qituvchilar juda malakali va har bir talabaga alohida e'tibor berishadi.",
    ...
    {
        text: "Grafik dizayn kursini tamomlab, hozirda frilanser sifatida ishlayapman. Kurs davomida amaliy loyihalar bilan shug'ullanish imkoniyati berildi, bu mening portfoliomni boyitdi.",
